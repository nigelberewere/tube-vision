...
import { Play, Square, Download, Loader2, Volume2, Settings2, Sparkles, Pause, Tags, Plus, Wand2, Sliders, Trash2 } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans bg-[#050505] text-slate-200">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          >
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
              ...
              <span className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">PRO</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-6">
        ...
        <motion.div 
          ...
          className="glass-card rounded-3xl overflow-hidden relative min-h-[400px] flex flex-col"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="glass-card rounded-3xl p-6 flex flex-col h-[400px]"
          >
