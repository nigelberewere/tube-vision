...
export function CookieConsentBanner({ theme = "dark", className }: CookieConsentBannerProps) {
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="space-y-1">
            ...
            <p className={cn("text-xs leading-relaxed md:text-sm", theme === "light" ? "text-slate-700" : "text-slate-300")}>
              We use essential cookies for security and sign-in reliability. You can also allow optional analytics
              cookies to help us improve Janso Studio.
            </p>
